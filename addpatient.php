        ...
        <div class="row topbar">
            <div class="col-md-12 bar">
                <div class="col-md-2 logo">
                    <a href="#"><center><img class="bbm" src="img/ucmed.png"></center></a>
                </div>
        ...
        <div class="row whole">
                ...
                <div class="sidebar col-md-2">
                    <div id = "bb" >
                        <a href="index.php" id="link">
                         <div class="navheight"><span>&nbsp&nbsp</span><p class="glyphicon glyphicon-folder-open centertext"></p> &nbsp DASHBOARD</div></a>
                       ...
                       <a href="appointments.php" id="link"><div class="navheight"> <span>&nbsp</span> <p class="glyphicon glyphicon-shopping-cart centertext"></p>&nbsp APPOINTMENTS</div></a>
            ...
            <div class="col-md-10 content" id="content">
              ...
              <div class="col-md-6 box1">                
                     <span class="glyphicon glyphicon-user"></span><span class="aplabel">First Name</span><input name="fname" type="text" class="apdesc" style="margin-left:40px"/>
                     <br><br>
                     <span class="glyphicon glyphicon-user"></span><span class="aplabel">Last Name</span><input name="lname" type="text" class="apdesc" style="margin-left:40px"/>
                     <br><br>
                    ...
                    <span class="fa fa-home"></span><span class="aplabel">Address</span><input name="address" type="text" class="apdesc" style="margin-left:57.5px"/>
                    <br><br>
                    <span class="fa fa-male"></span><span class="aplabel">Husband's name</span><input name="husband" type="text" class="apdesc" style="margin-left:10px"/>
                    <br><br>
                    <span class="fa fa-arrows-v"></span><span class="aplabel">Height</span><input name="height" type="number" class="apdesc" style="margin-left:74px"/>
                    <br><br>
                    <span class="fa fa-smile-o"></span><span class="aplabel">No. of times pregnant</span>  
                    <input name="gravida" type="number" class="apdesc" value = '1'style="margin-left:15px;width:40px;"/>
